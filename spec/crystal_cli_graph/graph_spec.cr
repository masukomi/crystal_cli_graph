...
describe CrystalCliGraph::Graph do
  ...
  # #
  # # end
  # it "should generate_y_label_columns correctly when > max_height and w/o labels" do
  #   # this should be a private method but it's broke so i'm writing a test
  #   opts = default_options
  #   opts[:max_height] = 1
  #   opts[:y_label] = "22"
  #   g = CrystalCliGraph::Graph.new(default_data, opts)
  #   columns = g.generate_y_label_columns(1, "22", false)
  ...
  #   opts[:y_label] = "22"
  #   g = CrystalCliGraph::Graph.new(default_data, opts)
  #   columns = g.generate_y_label_columns(3, "22", false)
  #   columns[0].strings.should(eq([" ", "2", "2"]))
  #   columns[1].strings.should(eq(["|", "|", "|"]))
  # end
  # it "should generate_y_label_columns correctly when < max_height and w/labels" do
  #   # this should be a private method but it's broke so i'm writing a test
  #   opts = default_options
  #   opts[:max_height] = 3
  #   opts[:y_label] = "22"
  #   g = CrystalCliGraph::Graph.new(default_data, opts)
  #   columns = g.generate_y_label_columns(3, "22", true)
  #   columns[0].strings.should(eq([" ", "2", "2", " "]))
  #   columns[1].strings.should(eq(["|", "|", "|", " "]))
  # end
